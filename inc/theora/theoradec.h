 ...
 */
THEORA int th_decode_headerin(th_info *_info,th_comment *_tc,
...
THEORA th_dec_ctx *th_decode_alloc(const th_info *_info,
...
THEORA void th_setup_free(th_setup_info *_setup);
...
THEORA int th_decode_ctl(th_dec_ctx *_dec,int _req,void *_buf,
 size_t _buf_sz);
...
THEORA int th_decode_packetin(th_dec_ctx *_dec,const ogg_packet *_op,
 ...
 */
THEORA int th_decode_ycbcr_out(th_dec_ctx *_dec,
 th_ycbcr_buffer _ycbcr);
/**Frees an allocated decoder instance.
 * \param _dec A #th_dec_ctx handle.*/
THEORA void th_decode_free(th_dec_ctx *_dec);
/*@}*/
/*@}*/
