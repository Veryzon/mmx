...
#ifndef __theora_dll__
#   ifdef _DEBUG
#       define THEORA DLLIMPORT extern 
#       define THEORAINL DLLIMPORT EMBED
#   else
#       define THEORA DLLIMPORT extern 
#       define THEORAINL DLLIMPORT EMBED
#   endif
#else
#   ifdef _DEBUG
#       define _THEORA DLLEXPORT
#       define THEORA DLLEXPORT extern 
#       define _THEORAINL DLLEXPORT INLINE
#       define THEORAINL DLLEXPORT EMBED
#   else
#       define _THEORA DLLEXPORT
#       define THEORA DLLEXPORT extern 
#       define _THEORAINL DLLEXPORT INLINE
 ...
 */
THEORA const char *theora_version_string(void);
...
*/
THEORA ogg_uint32_t theora_version_number(void);
 ...
 * \retval 0 Success
 */
THEORA int theora_encode_init(theora_state *th, theora_info *ti);
 ...
 * \retval 0 Success
 */
THEORA int theora_encode_YUVin(theora_state *t, yuv_buffer *yuv);
 ...
 * \retval 1 Success
 */
THEORA int theora_encode_packetout( theora_state *t, int last_p,
                                    ogg_packet *op);
 ...
 * \retval 0 Success
 */
THEORA int theora_encode_header(theora_state *t, ogg_packet *op);
 ...
 * \retval 0 Success
 */
THEORA int theora_encode_comment(theora_comment *tc, ogg_packet *op);
 ...
 * \retval 0 Success
 */
THEORA int theora_encode_tables(theora_state *t, ogg_packet *op);
 ...
 */
THEORA int theora_decode_header(theora_info *ci, theora_comment *cc,
                                ogg_packet *op);
 ...
 * \retval 0 Success
 */
THEORA int theora_decode_init(theora_state *th, theora_info *c);
 ...
 */
THEORA int theora_decode_packetin(theora_state *th,ogg_packet *op);
 ...
 * \retval 0 Success
 */
THEORA int theora_decode_YUVout(theora_state *th,yuv_buffer *yuv);
 ...
 */
THEORA int theora_packet_isheader(ogg_packet *op);
 ...
 * Thus function was added in the 1.0alpha4 release.
 */
THEORA int theora_packet_iskeyframe(ogg_packet *op);
 ...
 * Thus function was added in the 1.0alpha4 release.
 */
THEORA ogg_int64_t theora_granule_frame(theora_state *th,ogg_int64_t granulepos);
 ...
 */
THEORA double theora_granule_time(theora_state *th,ogg_int64_t granulepos);
 ...
 */
THEORA void theora_info_init(theora_info *c);
 ...
 * \param c A theora_info struct to initialize.
 */
THEORA void theora_info_clear(theora_info *c);

/**
 * Free all internal data associated with a theora_state handle.
 * \param t A theora_state handle.
 */
THEORA void theora_clear(theora_state *t);

/**
 * Initialize an allocated theora_comment structure
 * \param tc An allocated theora_comment structure 
 **/
THEORA void theora_comment_init(theora_comment *tc);
...
THEORA void theora_comment_add(theora_comment *tc, char *comment);
 ...
 * the theora_comment structure directly.
 **/
THEORA void theora_comment_add_tag(theora_comment *tc,
                                       char *tag, char *value);
...
THEORA char *theora_comment_query(theora_comment *tc, char *tag, int count);
 ...
 **/
THEORA int   theora_comment_query_count(theora_comment *tc, char *tag);

/**
 * Clear an allocated theora_comment struct so that it can be freed.
 * \param tc An allocated theora_comment structure.
 **/
THEORA void  theora_comment_clear(theora_comment *tc);
...
THEORA int theora_control(theora_state *th,int req,void *buf,size_t buf_sz);
